    ...
    <div class="x10f__main">\
      ...
      <div class="x10f__col">\
        ...
        <ul>' +
          ...
          li('/app-10xtyping/', IC_wave, L('10xTyping — Nói, để chữ tự viết', '10xTyping — Voice typing')) +
          li('/app-Markpicture/', IC_capture, L('MarkPicture — Camera bằng chứng', 'MarkPicture — Evidence camera')) +
